...
const QMetaObject Man::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Man.data,
      qt_meta_data_Man,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Man::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Man.stringdata0))
        return static_cast<void*>(const_cast< Man*>(this));
